...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("CommentChannel", {
  ...
  received: function received(_ref) {
    var post_id = _ref.post_id,
        comment_created = _ref.comment_created;
    var comments = document.querySelector(".comments");
    if (parseInt(comments.dataset.postId) !== post_id) return;
    var template = document.createElement("template");
    template.innerHTML = comment_created;
    document.querySelector("form.new-comment").insertAdjacentElement("beforebegin", template.content.firstChild);
  }
});
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("PostChannel", {
  ...
  received: function received(_ref) {
    var post_created = _ref.post_created;
    var template = document.createElement("template");
...
/******/ });
//# sourceMappingURL=application-2221e50d694306104566.js.map